...
def residual(t, SV, pars, ptr, flags):
    ...
    Q_cond_an = -lambda_an*dyInv_an*(SV[ptr.T_an] - SV[ptr.T_elyte])
    ...
    Q_cond_ca = -lambda_ca*dyInv_ca*(SV[ptr.T_elyte] - SV[ptr.T_ca])
    ...
    Q_rad = sigma*pars.emmissivity*(pars.T_amb**4 - SV[ptr.T_elyte]**4)*pars.A_ext
    Q_conv = pars.h_conv*(pars.T_amb - SV[ptr.T_elyte])*pars.A_ext
    """
    END CODING
    """
